...
local function log_filter_edit(is_find)
    ...
    if count == 0 then
        print("error: Filter with name: \"" .. name .. "\" is presented, need to set any parameter")
        return 1
    elseif count == 1 then
...
local function log_action_edit(is_find)
    ...
    if count == 0 then
        print("error: Action with name: \"" .. name .. "\" is presented, need to set any parameter")
        return 1
    elseif count == 1 then
        log_ubus_set_value_1 = log_ubus_set_value_1 .. log_ubus_set_value_list[1]
    elseif count > 1 then
...
local function log_rule_edit(is_find)
    ...
    if count == 0 then
        print("error: Ruele with name: \"" .. name .. "\" is presented, need to set any parameter")
        return 1
    elseif count == 1 then
        log_ubus_set_value_1 = log_ubus_set_value_1 .. log_ubus_set_value_list[1]
    elseif count > 1 then
...
local function filter_handler()
    ...
    elseif arg[2] == "delete" then
        ...
        elseif filter_listConfig[name] == nil then
            print("error: Filter with name \"" .. name .. "\" not presented")
        end
    end
end
...
local function action_handler()
    ...
    elseif arg[2] == "delete" then
        ...
        elseif action_listConfig[name] == nil then
            print("error: Action with name \"" .. name .. "\" not presented")
        end
    end
end
...
local function rule_handler()
    ...
    if arg[2] == "add" or arg[2] == "edit" then
        ...
        if rule_listArg["filter"] ~= "" and rule_listArg["filter"] ~= nil then
            ...
            if filter_listConfig[filter_name] == nil then
                print("error: Filter with name " .. filter_name .. " not found")
                print("add new filter \"config log add filter <params>\"  or use from list: ")
        ...
        if rule_listArg["action"] ~= "" and rule_listArg["action"] ~= nil then
            ...
            if action_listConfig[action_name] == nil then
                print("error: Action with name " .. action_name .. " not found")
                print("add new action \"config log add action <params>\"  or use from list: ")
    ...
    elseif arg[2] == "delete" then
        ...
        elseif rule_listConfig[name] == nil then
            print("error: Rule with name \"" .. name .. "\" not presented")
        end
    end
end
