...
local function show_io_status(sensor_name)
    ...
    local res = ""
    if sensor_name == "relay" then
        print(i2c.sensorList[4].name)
        print(i2c.sensorList[4].msg.state .. jsonSensorInfo.relay)
    else
        print(i2c.sensorList[1].name)
        res = tostring(jsonSensorInfo.tamper)
        print(i2c.sensorList[1].msg.state .. sensorsEnum[res])
        print(i2c.sensorList[2].name)
        res = tostring(jsonSensorInfo.sensor1)
        print(i2c.sensorList[2].msg.state .. sensorsEnum[res])
        print(i2c.sensorList[3].name)
        res = tostring(jsonSensorInfo.sensor2)
