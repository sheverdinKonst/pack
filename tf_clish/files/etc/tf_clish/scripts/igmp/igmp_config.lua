...
local function getIgmpSatus(option)
    local error = ""
...
local function igmp_config_State(option)
...
local function igmp_config_Max_snooping_table_size(option)
...
local function igmp_config_Enable_multicast_querier(option)
...
local function igmp_config_Robustness(option)
...
local function igmp_config_Query_interval(option)
...
local function igmp_config_Query_response_interval(option)
    local error = 1
...
local function igmp_config_Last_member_interval(option)
    local error = 1
...
local function config_igmp(cmdList)
    local error = 1
